...
\begin{figure}[h]
    \centering
    \includesvg[width=0.25\textwidth]{/workspaces/elec0041/homework-1/report/geometry.svg}
...
\begin{figure}[h]
    \centering
    \includesvg[width=\textwidth]{/workspaces/elec0041/homework-1/test_mesh_convergence.svg}
    \caption{
        Convergence study.
