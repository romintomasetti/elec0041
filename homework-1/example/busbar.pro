Group {
  Busbar = Region[11];
  ElectrodeIn = Region[12];
  ElectrodeOut1 = Region[13];
  ElectrodeOut2 = Region[14];

  Vol_Ele = Region[ {Busbar} ];
  Sur_Neu_Ele = Region[ {} ];
  Sur_Electrodes_Ele = Region [ {ElectrodeIn, ElectrodeOut1, ElectrodeOut2} ];
}
...
Constraint {
  ...
  { Name SetGlobalPotential; Type Assign;
    Case {
      { Region ElectrodeOut1; Value 0; }
      { Region ElectrodeOut2; Value 0; }
    }
  }
